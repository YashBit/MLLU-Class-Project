...
# ------------------------------------------------------------------------------------------- #
# modification of the DeBERTa source code
# author: Yilun Kuang
# date: 15:50:08 Friday April 16, 2021, China Standard Time
# ------------------------------------------------------------------------------------------- # 
...
class DebertaEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, mask=None, inputs_embeds=None):
        ...
        # date: 15:50:08 Friday April 16, 2021, China Standard Time
        # ------------------------------------------------------------------------------------------- #
        print('we are working with the SiFT version of DeBERTa and it works!')
        noise_SiFT = generate_noise(embeddings, mask, epsilon=1)
        embeddings = embeddings + noise_SiFT
        # ------------------------------------------------------------------------------------------- # 
